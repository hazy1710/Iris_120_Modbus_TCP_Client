...
Это клиент для подключения к щитовому прибору ИРИС-120 по Modbus-TCP. Приложение опрашивает регистры (напряжения тока и частоты) ИРИС-120 через Modbus-TCP и выводит из на экран.
